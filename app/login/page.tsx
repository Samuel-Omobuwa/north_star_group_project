        ...
        <div className="w-full max-w-sm space-y-4">
          ...
          <div className="relative">
            <Input
              ...
              className="bg-gray-800 border-gray-700 text-white placeholder:text-gray-500 focus:border-blue-500 focus:ring-blue-500 pr-10"
            />
            <button
              type="button"
          ...
          <Button
            variant="outline"
            className="w-full bg-white hover:bg-gray-50 text-gray-900 border-gray-300 py-3"
            size="lg"
          >
