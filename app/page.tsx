...
const aboutUsBg = "/background/aboutBgImg.png";
  ...
  return (
    <div className="min-h-screen ">
      ...
      <main className="container mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-6">
                <p className="text-blue-400 font-bold font-medium tracking-wide uppercase text-sm">
                ...
                <p className="text-gray-300 text-lg leading-relaxed max-w-lg">
                  Spend and save in physical gold and silver. Buy digital
                  currency. Earn rewards for every transaction
                </p>
              </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
            <div className="text-center space-y-4">
              ...
              <p className="text-gray-400 text-sm">
                Spend and save in digitalized physical gold and silver.
              </p>
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-gray-400 text-sm">
                Earn gold and silver just for spending and transacting.
              </p>
              <Button variant="link" className="text-blue-400 p-0">
                Learn More →
              </Button>
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-gray-400 text-sm">
                Spend gold, silver and digital currency globally with the NSG
                card.
              </p>
              <Button variant="link" className="text-blue-400 p-0">
                Learn More →
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-gray-400 text-sm">
                Be sure of your gold and silver with our world-class security.
              </p>
              <Button variant="link" className="text-blue-400 p-0">
                Learn More →
              </Button>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4 p-4 rounded-lg bg-gray-800/50">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm mb-2">
                    Take full control of your finances on the move. Buy gold,
                    silver and digital currency.
                  </p>
                  <Button variant="link" className="text-blue-400 p-0 text-sm">
                    Learn More →
                  </Button>
              ...
              <div className="flex items-start gap-4 p-4 rounded-lg bg-gray-800/50">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm mb-2">
                    Spend gold, silver and digital currency globally with the
                    NSG card.
                  </p>
                  <Button variant="link" className="text-blue-400 p-0 text-sm">
                    Learn More →
            ...
            <div>
              ...
              <div className=" pb-7">
                ...
                <p className="text-gray-300">
                 Keep an eye on your spending and svings, always. Get digital currency. Instantly buy gold and silver in real-time pricing.
                </p>
              </div>

              <div className="space-y-8">
                <div className="bg-[#1B1B27] p-7">
                  <h3 className="text-xl font-semibold text-white mb-2">
                    Stay connected
                  </h3>
                  <p className="text-gray-300">
                    Manage your spending and savings. Always get digital
                    currency. Instantly buy gold and silver in real-time
                    pricing.
                  </p>
                </div>
                ...
                <div className="bg-[#1B1B27] p-7">
                  ...
                  <p className="text-gray-300">
                    Buy gold, silver and digital currency in seconds, 24/7, or
                    sell your own price.
                  </p>
                </div>
              </div>
        ...
        <div
          className="grid lg:grid-cols-2 gap-12 items-center my-20 h-96 rounded-lg p-10"
          style={{
        ...
        >
          <div className="space-y-6">
            ...
            <h3 className="text-3xl font-bold text-white">
              Built by a team of world-class money & fintech experts backed by a
              network of retail, wholesale & institutional partners
            </h3>
        ...
        <section className="py-20">
          <div className="mb-16">
            ...
            <p className="text-gray-300 text-lg max-w-2xl">
              ...
              family around the globe, with a low, flat fee. They&apos;ll get it
              in 2-3 seconds - every time.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-20">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  A flat 0.45% fee. Any amount, sent any time to anywhere in the
                  world.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  Make payments in gold and silver cleared within seconds, 24/7.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  The same low cost, whether weekday or weekend, all year round.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-3xl">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Biometric and physical 2FA checks ensure your assets&apos;
                    safety.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Credit card-size, convenient and accessible, wherever you
                    go.
                  </p>
                </div>
              </div>
